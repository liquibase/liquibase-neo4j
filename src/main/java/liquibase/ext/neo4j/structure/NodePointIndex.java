...
public class NodePointIndex extends AbstractDatabaseObject implements CatalogLevelObject, NodeIndex {
    ...
    public NodePointIndex(Catalog catalog, String name, String label, String property, String indexProvider, Map<String, Object> indexConfig) {
