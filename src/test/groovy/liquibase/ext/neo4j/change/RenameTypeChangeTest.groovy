...
class RenameTypeChangeTest extends Specification {
    ...
    def "rejects invalid configuration"() {
        ...
        false   | false   | "SEEN_BY" | "VIEWED_BY" | true              | 1000L     | "()-[__rel__]->()"    | "__rel__"      | "outputVariable __rel__ clashes with one of the following reserved variable names: __rel__, __start__, __end__, __newrel__. outputVariable must be renamed and fragment accordingly updated"
        false   | false   | "SEEN_BY" | "VIEWED_BY" | true              | 1000L     | "()-[__start__]->()"  | "__start__"    | "outputVariable __start__ clashes with one of the following reserved variable names: __rel__, __start__, __end__, __newrel__. outputVariable must be renamed and fragment accordingly updated"
        false   | false   | "SEEN_BY" | "VIEWED_BY" | true              | 1000L     | "()-[__end__]->()"    | "__end__"      | "outputVariable __end__ clashes with one of the following reserved variable names: __rel__, __start__, __end__, __newrel__. outputVariable must be renamed and fragment accordingly updated"
        false   | false   | "SEEN_BY" | "VIEWED_BY" | true              | 1000L     | "()-[__newrel__]->()" | "__newrel__"   | "outputVariable __newrel__ clashes with one of the following reserved variable names: __rel__, __start__, __end__, __newrel__. outputVariable must be renamed and fragment accordingly updated"
